...
# --- DEMO SETTINGS (SIDEBAR) ---
st.sidebar.title("⚙️ Live Demo Settings")
st.sidebar.caption("Override the database to send OTPs to a live tester.")
demo_email = st.sidebar.text_input("Override Receiver Email:", value="davidleesi2201@gmail.com")

# Instantly update the database with whatever is typed in the sidebar
if "student1" in st.session_state.users_db:
    st.session_state.users_db["student1"]["email"] = demo_email
